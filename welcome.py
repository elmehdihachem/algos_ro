...
class WelcomeScreen(tk.Frame):
    def __init__(self, master=None):
        ...
        self.right_frame = tk.Frame(self.container, bg="#B8CBD0", width=500)
    ...
    def _create_left_content(self):
        ...
        # Animated separator
        separator = tk.Frame(self.left_frame, height=3, width=0, bg="#B8CBD0")
        ...
        # Student info
        self._create_info_card("Presented by", "HACHEM El Mehdi", 10)
        # Professor info
    ...
    def _create_right_content(self):
        content_frame = tk.Frame(self.right_frame, bg="#B8CBD0", padx=30)
        ...
        for algo in algorithms:
            algo_frame = tk.Frame(content_frame, bg="#B8CBD0")
        ...
        # Hover effects
        def on_enter(e):
            start_button.configure(bg="#18534F", fg="white", relief=tk.RAISED)
